...
void listar(TListaRegistro *registros);
...
void inicializarMenu(){
    ...
    do{
        ...
        if(continuar == 1){
			...
			TRegistro *consulta = (TRegistro *)malloc(sizeof(TRegistro));
				        	
           	printf("\nInforme o nome: ");
           	gets(consulta->nome);
           	gets(consulta->nome);
           	
           	consultar_registro(&registros, consulta);  
			...
			TRegistro *excluir = (TRegistro *)malloc(sizeof(TRegistro));
				        	
           	printf("\nInforme o nome: ");
           	gets(excluir->nome);
			gets(excluir->nome);
           	
           	excluir_registro(&registros, excluir);
